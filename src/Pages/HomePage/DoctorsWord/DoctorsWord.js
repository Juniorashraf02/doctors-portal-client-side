            ...
            <div className="hero ">
                <div className="hero-content flex-col lg:flex-row gap-20">
                    ...
                    <div className=' text-left'>
                        ...
                        <button onClick={handleClick} className="btn btn-tertiary font-bold bg-gradient-to-r from-primary to-secondary border-0 text-white">See customer review</button>
                    </div>
                </div>
            </div>
        </div>
